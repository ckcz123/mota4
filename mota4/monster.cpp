...
void c_monster::init(int t)
{
	...
	case 8:wcscpy_s(name,L"冥灵魔王");position=7;hp=700;atk=290;def=120;money=27;break;
	...
	case 23:wcscpy_s(name,L"高级卫兵");position=22;hp=560;atk=300;def=160;money=33;break;
	case 24:wcscpy_s(name,L"双手剑士");position=23;hp=580;atk=380;def=0;money=29;special=1;break;
	case 25:wcscpy_s(name,L"冥战士");position=24;hp=888;atk=388;def=88;money=38;break;
